...
from slackapptk3.errors import SlackAppTKUnhandledRequestError
from slackapptk3.request.action_event import BlockActionEvent, ActionEvent
from slackapptk3.request.view import ViewRequest, View
from slackapptk3.request.outmoded import *
...
class BlockActionRequest(AnyRequest):
    def __init__(self, app, payload):
        ...
        if c_type == "view":
            ...
            app.log.error(f"Unknown block action container type: {c_type}")
...
def InteractiveRequest(
    ...
    if not rqst_cls:
        ...
        app.log.error(emsg)
        raise SlackAppTKUnhandledRequestError(app=app, payload=payload)
